      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () async {
            ...
            try {
//https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=0ec9e81052acada4b61a0e98229b431d&redirect_uri=http://172.30.1.16:8080

              // await AuthCodeClient.instance.authorizeWithTalk(
              //     redirectUri: 'https://i8b309.p.ssafy.io/oauth2/login',
              //     clientId: '0ec9e81052acada4b61a0e98229b431d',
              //
              // );
